...
public class VpFragment2 extends Fragment implements DiffView{
    private GridView gv;
    private GVAdapter gvAdapter;
    private DiffPresenter diffPresenter;
    private List<DiffBean.DataBean> glist2 = new ArrayList<>();
    @Nullable
    @Override
    ...
    public void showdiff(DiffBean diffBean) {
        ...
        gvAdapter = new GVAdapter(glist2,getContext());
